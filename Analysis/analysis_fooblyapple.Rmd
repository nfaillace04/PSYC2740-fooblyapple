...
priming_data %>%
  group_by(valence) %>%
    ...
    geom_col(mapping = aes(x = valence, y = mean_rt,
             ...
             position = "dodge")+
    theme_classic()
#based on the bar graph, the negative mean_rt does appear to be slightly higher than the other valence conditions, and the positive response time appears to have the lowest mean_rt. Neutral and unrelated trials seem to have similar mean_rts with unrelated being only slightly lower.
