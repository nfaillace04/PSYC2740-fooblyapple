...
counts = revised_critical_data %>%
  ...
  count()
```
Exclusions: The number of participants initially recruited was 147. We excluded 57 participants based on pre-registration criteria, and another 10 for not completing all parts of the experiment. In our models, we analyzed the data from 80 total participants. 
```{r}
